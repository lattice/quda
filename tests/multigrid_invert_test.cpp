...
/*
void setGaugeParamLocal(QudaGaugeParam &gauge_param)
{
...
void setEigParamLocal(QudaEigParam &mg_eig_param, int level)
{
...
void setMultigridParamLocal(QudaMultigridParam &mg_param)
{
...
void setInvertParamLocal(QudaInvertParam &inv_param) {
  inv_param.Ls = 1;
