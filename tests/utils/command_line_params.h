...
extern double hmc_mg_setup_iter_ratio;
extern int hmc_mg_setup_iter_baseline_traj;
...
extern int eigentracking_trlm_check_interval;
extern QudaEigType eigentracking_eig_type;
extern int eigentracking_blk_size;
...
extern std::string corrdist_config_prefix;
extern int corrdist_config_start;
extern int corrdist_config_end;
