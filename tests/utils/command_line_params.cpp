...
std::shared_ptr<QUDAApp> make_app(std::string app_description, std::string app_name)
{
  ...
  quda_app->add_option("--clover-c-sw", clover_c_sw, "Clover Csw coefficient 1.0")->capture_default_str();  
  quda_app->add_option("--clover-coeff", clover_coeff, "The overall clover coefficient, kappa * Csw. (default 0. Will be inferred from clover-c-sw and kappa. "
