...
#pragma omp parallel for
    for (int i = 0; i < Vh; i++) {
      ...
      for (int dir = 0; dir < 8; dir++) {
        ...
        gFloat *twolnk = gaugeLink(i, dir, oddBit, twolinkEven, twolinkOdd, ghostTwolinkEven, ghostTwolinkOdd, 3, 2); //?

        sFloat *second_neighbor_spinor = spinorNeighbor_5d<QUDA_4D_PC>(i, dir, oddBit, spinorField, fwd_nbr_spinor,
