...
namespace milc_interface {
      ...
      QudaInvertParam *invertParam)
  {
    ...
    invertParam->tol_precondition = 1e-10;
    invertParam->maxiter_precondition = 100;
    invertParam->verbosity_precondition = QUDA_SILENT;
    invertParam->cuda_prec_precondition = cuda_prec_precondition;
    invertParam->precondition_cycle     = 0; // need to understand this!
      ...
      QudaGaugeParam *gaugeParam)   
  {
    ...
    gaugeParam->precondition = NULL; // will probably remove this anyway
    return;
  }
