...
namespace quda
{
   ...
   */
  void gaugeForce(GaugeField &mom, const GaugeField &u, real_t coeff, std::vector<int **> &input_path,
                  std::vector<int> &length, std::vector<real_t> &path_coeff, int num_paths, int max_length);
  ...
  void gaugeLoopTrace(const GaugeField &u, std::vector<complex_t> &loop_traces, real_t factor,
                      std::vector<int **> &input_path, std::vector<int> &length, std::vector<real_t> &path_coeff_h,
