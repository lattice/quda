...
#define QUDA_NORMERR_CHIRAL_SOLVE 6
#define QUDA_NORMOP_CHIRAL_SOLVE QUDA_NORMERR_CHIRAL_SOLVE // P M^\dag M P == P M M^\dag P
...
#define QudaChirality integer(4)
#define QUDA_LEFT_CHIRALITY -1
#define QUDA_RIGHT_CHIRALITY +1
#define QUDA_INVALID_CHIRALITY QUDA_INVALID_ENUM
