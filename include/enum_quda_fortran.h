...
#define QudaStaggeredLocalType integer(4)
#define QUDA_STAGGERED_LOCAL_STEP1 0
#define QUDA_STAGGERED_LOCAL_STEP2 1
#define QUDA_STAGGERED_LOCAL_CLOVER 2
#define QUDA_STAGGERED_LOCAL_INVALID QUDA_INVALID_ENUM
