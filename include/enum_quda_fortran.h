...
#define QUDA_WILSON_LINKS         QUDA_SUN_LINKS
...
#define QUDA_RECONSTRUCT_NO 2*N_COLORS*N_COLORS
#define QUDA_RECONSTRUCT_12 2*N_COLORS*(N_COLORS-1)
#define QUDA_RECONSTRUCT_8 N_COLORS*N_COLORS-1
#define QUDA_RECONSTRUCT_9 N_COLORS*N_COLORS
#define QUDA_RECONSTRUCT_13 2*N_COLORS*(N_COLORS-1)+1
#define QUDA_RECONSTRUCT_10 N_COLORS*N_COLORS+1
