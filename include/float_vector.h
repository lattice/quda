...
//Additional subroutines with explicite intrinsics

  __host__ __device__ inline void _fma3(const float &a, const float2 &x, float2 &y) {
#if defined( __CUDA_ARCH__)
    y.x  = __fmaf_rn (a, x.x, y.x);
    y.y  = __fmaf_rn (a, x.y, y.y);
#else
    y.x  += a*x.x;
    y.y  += a*x.y;
#endif
  ...
  __host__ __device__ inline void _fma3(const float &a, const float4 &x, float4 &y) {
#if defined( __CUDA_ARCH__)
    y.x  = __fmaf_rn (a, x.x, y.x);
    y.y  = __fmaf_rn (a, x.y, y.y);
    y.z  = __fmaf_rn (a, x.z, y.z);
    y.w  = __fmaf_rn (a, x.w, y.w);
#else
    y.x  += a*x.x;
    y.y  += a*x.y;
    y.z  += a*x.z;
  ...
  __host__ __device__ inline void _fma3(const double &a, const double2 &x, double2 &y) {
#if defined( __CUDA_ARCH__)
    y.x  = __fma_rn (a, x.x, y.x);
    y.y  = __fma_rn (a, x.y, y.y);
#else
    y.x  += a*x.x;
    y.y  += a*x.y;
#endif
  ...
  __host__ __device__ inline void _fma3(const double &a, const double4 &x, double4 &y) {
#if defined( __CUDA_ARCH__)
    y.x  = __fma_rn (a, x.x, y.x);
    y.y  = __fma_rn (a, x.y, y.y);
    y.z  = __fma_rn (a, x.z, y.z);
    y.w  = __fma_rn (a, x.w, y.w);
#else
    y.x  += a*x.x;
    y.y  += a*x.y;
    y.z  += a*x.z;
  ...
  __host__ __device__ inline void _fma2(const float &a, float2 &x, const float2 &y) {
#if defined( __CUDA_ARCH__)
    x.x  = __fmaf_rn (a, x.x, y.x);
    x.y  = __fmaf_rn (a, x.y, y.y);
#else
    x.x  = a*x.x + y.x;
    x.y  = a*x.y + y.y;
#endif
  ...
  __host__ __device__ inline void _fma2(const float &a, float4 &x, const float4 &y) {
#if defined( __CUDA_ARCH__)
    x.x  = __fmaf_rn (a, x.x, y.x);
    x.y  = __fmaf_rn (a, x.y, y.y);
    x.z  = __fmaf_rn (a, x.z, y.z);
    x.w  = __fmaf_rn (a, x.w, y.w);
#else
    x.x  = a*x.x + y.x;
    x.y  = a*x.y + y.y;
    x.z  = a*x.z + y.z;
  ...
  __host__ __device__ inline void _fma2(const double &a, double2 &x, const double2 &y) {
#if defined( __CUDA_ARCH__)
    x.x  = __fma_rn (a, x.x, y.x);
    x.y  = __fma_rn (a, x.y, y.y);
#else
    x.x  = a*x.x + y.x;
    x.y  = a*x.y + y.y;
#endif
  ...
  __host__ __device__ inline void _fma2(const double &a, double4 &x, const double4 &y) {
#if defined( __CUDA_ARCH__)
    x.x  = __fma_rn (a, x.x, y.x);
    x.y  = __fma_rn (a, x.y, y.y);
    x.z  = __fma_rn (a, x.z, y.z);
    x.w  = __fma_rn (a, x.w, y.w);
#else
    x.x  = a*x.x + y.x;
    x.y  = a*x.y + y.y;
    x.z  = a*x.z + y.z;
