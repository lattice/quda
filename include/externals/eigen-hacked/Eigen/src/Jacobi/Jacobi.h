...
bool JacobiRotation<Scalar>::makeJacobi(const RealScalar& x, const Scalar& y, const RealScalar& z)
{
  ...
  else
  {
    ...
    RealScalar w = numext::sqrt(numext::abs2(tau) + RealScalar(1));
    RealScalar t;
    if(tau>RealScalar(0))
    {
    ...
    RealScalar n = RealScalar(1) / numext::sqrt(numext::abs2(t)+RealScalar(1));
...
void JacobiRotation<Scalar>::makeGivens(const Scalar& p, const Scalar& q, Scalar* r, internal::true_type)
{
  ...
  else
  {
    ...
    if(p1>=q1)
    {
      ...
      RealScalar u = numext::sqrt(RealScalar(1) + q2/p2);
    ...
    else
    {
      ...
      RealScalar u = q1 * numext::sqrt(p2 + q2);
      if(numext::real(p)<RealScalar(0))
        u = -u;
