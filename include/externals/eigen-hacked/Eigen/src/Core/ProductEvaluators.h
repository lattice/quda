...
struct permutation_matrix_product<ExpressionType, Side, Transposed, DenseShape>
{
    ...
    EIGEN_DEVICE_FUNC static inline void run(Dest& dst, const PermutationType& perm, const ExpressionType& xpr)
    {
      MatrixType mat(xpr);
...
{
  template<typename Dest>
  EIGEN_DEVICE_FUNC static void evalTo(Dest& dst, const Lhs& lhs, const Rhs& rhs)
  {
...
{
  template<typename Dest>
  EIGEN_DEVICE_FUNC static void evalTo(Dest& dst, const Inverse<Lhs>& lhs, const Rhs& rhs)
  {
...
{
  template<typename Dest>
  EIGEN_DEVICE_FUNC static void evalTo(Dest& dst, const Lhs& lhs, const Inverse<Rhs>& rhs)
  {
...
struct transposition_matrix_product
{
  ...
  EIGEN_DEVICE_FUNC static inline void run(Dest& dst, const TranspositionType& tr, const ExpressionType& xpr)
  {
    MatrixType mat(xpr);
...
{
  template<typename Dest>
  EIGEN_DEVICE_FUNC static void evalTo(Dest& dst, const Transpose<Lhs>& lhs, const Rhs& rhs)
  {
...
{
  template<typename Dest>
  EIGEN_DEVICE_FUNC static void evalTo(Dest& dst, const Lhs& lhs, const Transpose<Rhs>& rhs)
  {
