  ...
  class ColorSpinorParam : public LatticeFieldParam {
    public:
      ...
      ColorSpinorParam()
        ...
        gammaBasis(QUDA_INVALID_GAMMA_BASIS), create(QUDA_INVALID_FIELD_CREATE), eigv_dim(0), eigv_id(-1) { ; }
      ...
      ColorSpinorParam(ColorSpinorParam &cpuParam, QudaInvertParam &inv_param) 
        ...
        create(QUDA_COPY_FIELD_CREATE), v(0), eigv_dim(cpuParam.eigv_dim), eigv_id(-1)
        {
