...
namespace quda
{
  ...
  public:
    ...
    */
    template <typename... Arg> static constexpr unsigned int get_offset(dim3 block, const Arg &...arg)
    {
      unsigned int o = 0;
    ...
    */
    template <typename... Arg> static constexpr unsigned int shared_mem_size(dim3 block, const Arg &...arg)
    {
