...
namespace quda
{
  ...
  namespace reduction_prefetch
  {
    ...
    inline constexpr bool reduction_functor_prefetch_2d_v = requires(Transformer<Arg> &t) { t.prefetch(0, 0); };

    template <template <typename> class Functor, typename Arg>
    inline constexpr bool reduction_functor_prefetch_3d_v = requires(Functor<Arg> &t) { t.prefetch(0, 0, 0); };
  } // namespace reduction_prefetch
