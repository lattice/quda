...
namespace std
{
  ...
  inline quda::float128_t sqrt(quda::float128_t x) { return quda::fp128::sqrt(x); }
  inline quda::float128_t abs(quda::float128_t x) { return quda::fp128::fabs(x); }
  inline quda::float128_t cbrt(quda::float128_t x) { return quda::fp128::cbrt(x); }
  inline quda::float128_t sin(quda::float128_t x) { return quda::fp128::sin(x); }
  inline quda::float128_t cos(quda::float128_t x) { return quda::fp128::cos(x); }
  inline quda::float128_t sinh(quda::float128_t x) { return quda::fp128::sinh(x); }
  inline quda::float128_t cosh(quda::float128_t x) { return quda::fp128::cosh(x); }
  inline quda::float128_t acos(quda::float128_t x) { return quda::fp128::acos(x); }
  inline quda::float128_t asinh(quda::float128_t x) { return quda::fp128::asinh(x); }
  inline quda::float128_t acosh(quda::float128_t x) { return quda::fp128::acosh(x); }
  inline quda::float128_t fabs(quda::float128_t x) { return quda::fp128::fabs(x); }
  inline quda::float128_t exp(quda::float128_t x) { return quda::fp128::exp(x); }
  inline quda::float128_t log(quda::float128_t x) { return quda::fp128::log(x); }
  inline quda::float128_t pow(quda::float128_t x, quda::float128_t y) { return quda::fp128::pow(x, y); }
  inline quda::float128_t fmod(quda::float128_t x, quda::float128_t y) { return quda::fp128::fmod(x, y); }
  inline quda::float128_t hypot(quda::float128_t x, quda::float128_t y) { return quda::fp128::hypot(x, y); }
  inline bool isinf(quda::float128_t x) { return quda::fp128::isinf(x); }
  inline bool isnan(quda::float128_t x) { return quda::fp128::isnan(x); }
  inline bool isfinite(quda::float128_t x) { return quda::fp128::isfinite(x); }
  ...
  public:
    ...
    static constexpr quda::float128_t infinity() { return quda::fp128::huge_val(); }
    static quda::float128_t quiet_NaN() { return quda::fp128::nan(); }
    static quda::float128_t signaling_NaN() { return quda::fp128::nans(); }
...
#if !defined(__CUDACC__)
  inline float128_t fabs(float128_t x) { return fp128::fabs(x); }
#endif
