  ...
  */
  struct XUpdateBatch {
    ...
    */
    ...
    {
      std::vector<real_t> a(_alphas.begin(), _alphas.begin() + _j + 1);
      cvector_ref<const ColorSpinorField> ps(_ps.begin(), _ps.begin() + _j + 1);
      vector_ref<ColorSpinorField> y(x);
      blas::block::axpy<real_t>(a, ps, y);
    }
