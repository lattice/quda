...
namespace quda {
  ...
  /**
    ...
    @param block number to calculate the index's, the total number of blocks is nColor * ( nColor - 1) / 2.
 ...
 */
  ...
  /**
    @brief Calculate the SU(2) index block in the SU(Nc) matrix
    @param block number to calculate de index's, the total number of blocks is nColor * ( nColor - 1) / 2.
