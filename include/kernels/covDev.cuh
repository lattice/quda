...
namespace quda {
  ...
  */
  ...
  struct CovDevArg : DslashArg<Float> {
  ...
  */
  ...
  __device__ __host__ inline void covDev(Arg &arg, int idx, int parity) {
    ...
    case 0: applyCovDev<Float,nDim,nColor,nParity,dagger,kernel_type,0>(out, arg, coord, x_cb, parity, idx, thread_dim, active); break;
    case 1: applyCovDev<Float,nDim,nColor,nParity,dagger,kernel_type,1>(out, arg, coord, x_cb, parity, idx, thread_dim, active); break;
    case 2: applyCovDev<Float,nDim,nColor,nParity,dagger,kernel_type,2>(out, arg, coord, x_cb, parity, idx, thread_dim, active); break;
    case 3: applyCovDev<Float,nDim,nColor,nParity,dagger,kernel_type,3>(out, arg, coord, x_cb, parity, idx, thread_dim, active); break;
    case 4: applyCovDev<Float,nDim,nColor,nParity,dagger,kernel_type,4>(out, arg, coord, x_cb, parity, idx, thread_dim, active); break;
    case 5: applyCovDev<Float,nDim,nColor,nParity,dagger,kernel_type,5>(out, arg, coord, x_cb, parity, idx, thread_dim, active); break;
    case 6: applyCovDev<Float,nDim,nColor,nParity,dagger,kernel_type,6>(out, arg, coord, x_cb, parity, idx, thread_dim, active); break;
    case 7: applyCovDev<Float,nDim,nColor,nParity,dagger,kernel_type,7>(out, arg, coord, x_cb, parity, idx, thread_dim, active); break;
    }
