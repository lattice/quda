...
namespace quda
{
  ...
  template <bool dagger, int twist, QudaPCType pc, typename Arg, typename... Env_> __global__ void packKernel(Arg arg, Env_... env_)
  {
  ...
  template <bool dagger, int twist, QudaPCType pc, typename Arg, typename... Env_> __global__ void packShmemKernel(Arg arg, Env_... env_)
  {
  ...
  template <typename Arg, typename... Env_> __global__ void packStaggeredShmemKernel(Arg arg, Env_... env_)
  {
