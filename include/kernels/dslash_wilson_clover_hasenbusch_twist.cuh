...
namespace quda
{
  ...
  template <bool dagger, bool xpay, KernelType kernel_type, typename Arg> struct cloverHasenbusch : dslash_default {

    const Arg &arg;
    template <typename Ftor>
    constexpr cloverHasenbusch(const Ftor &ftor) : dslash_default {ftor.block_idx}, arg(ftor.arg)
    {
    }
