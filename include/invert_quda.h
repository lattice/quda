...
namespace quda {
  ...
  struct SolverParam {
    ...
    */
    ...
    SolverParam(QudaInvertParam &param) : inv_type(param.inv_type), 
      inv_type_precondition(param.inv_type_precondition), overlap_precondition(param.overlap),
  ...
  */
  ...
  struct DeflationParam {
    ...
    DeflationParam(ColorSpinorParam &eigv_param, SolverParam &param) : cur_dim(0), rtz_dim(0), added_nevs(0), cuda_ritz_alloc(true){
