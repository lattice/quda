    ...
    >
{
  ...
  __host__ __device__
  void launch(size_type num_blocks, size_type block_size, size_type num_dynamic_smem_bytes, hipStream_t stream, task_type task)
  {
    if(num_blocks > 0)
    {
  ...
  : public cuda_launcher_base<blocksize, typename cuda_grid<gridsize,blocksize,grainsize>::type,Closure>
{
  ...
  __host__ __device__
  void launch(grid_type request, Closure c, hipStream_t stream)
  {
  ...
  : public cuda_launcher_base<blocksize,concurrent_group<agent<grainsize>,blocksize>,Closure>
{
  ...
  __host__ __device__
  void launch(block_type request, Closure c, hipStream_t stream)
  {
  ...
  : public cuda_launcher_base<dynamic_group_size, parallel_group<agent<grainsize>,groupsize>,Closure>
{
  ...
  __host__ __device__
  void launch(group_type g, Closure c, hipStream_t stream)
  {
