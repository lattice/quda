...
namespace quda
{
  ...
  void contractSpatialQuda(const ColorSpinorField &x, const ColorSpinorField &y, size_t s1, size_t b1, void *result, QudaContractType cType, int local_corr_length);
