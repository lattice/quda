...
extern "C" {
  ...
  typedef enum QudaTwistCloverDslashType_s {
    QUDA_DEG_CLOVER_TWIST_INV_DSLASH = 1,
    QUDA_DEG_DSLASH_CLOVER_TWIST_INV = 2,
    QUDA_DEG_DSLASH_CLOVER_TWIST_XPAY = 4,
    QUDA_NDEG_CLOVER_TWIST_INV_DSLASH = 8,
    QUDA_NDEG_DSLASH_CLOVER_TWIST_INV = 16,
    QUDA_NDEG_DSLASH_CLOVER_TWIST_XPAY = 32,
