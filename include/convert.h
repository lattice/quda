...
namespace quda
{
  ...
  */
  ...
  __host__ __device__ inline
    typename std::enable_if<!isFixed<T1>::value && isFixed<T2>::value && !std::is_same<T1, __half>::value, void>::type
    copy(T1 &a, const T2 &b)
  {
  ...
  */
  ...
  template <typename T1, typename T2, typename T3>
  __host__ __device__ inline typename std::enable_if<isFixed<T2>::value && !std::is_same<T1, __half>::value, void>::type
  copy_and_scale(T1 &a, const T2 &b, const T3 &c)
  {
