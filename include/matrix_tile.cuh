...
namespace quda
{
   ...
   */
  template <typename T, int m, int n, bool ghost> struct MatrixTile {
...
#pragma unroll
      for (int i = 0; i < m; i++) {
#pragma unroll
        for (int j = 0; j < n; j++) { tile[i * n + j] = 0.0; }
      }
    }

    inline __device__ __host__ const T &operator()(int i, int j) const { return tile[i * n + j]; }

    inline __device__ __host__ T &operator()(int i, int j) { return tile[i * n + j]; }
...
#pragma unroll
      for (int i = 0; i < m; i++) {
#pragma unroll
        for (int j = 0; j < n; j++) { tile[i * n + j] *= a; }
      }
    }
...
#pragma unroll
        for (int j = 0; j < n; j++) {
#pragma unroll
          for (int l = 0; l < k; l++) { tile[i * n + j] = cmac(a.tile[i * k + l], b.tile[l * n + j], tile[i * n + j]); }
        }
      }
    }
...
#pragma unroll
    ...
    inline __device__ __host__ typename std::enable_if<Accessor::supports_ghost_zone, void>::type
    load(const Accessor &a, int d, int parity, int x_cb, int i0, int j0)
    {
#pragma unroll
      for (int i = 0; i < m; i++) {
#pragma unroll
...
#pragma unroll
      for (int i = 0; i < m; i++) {
#pragma unroll
        for (int j = 0; j < n; j++) { tile[i * n + j] = a(d, parity, x_cb, i0 + i, j0 + j); }
      }
    }

    template <typename Accessor>
    inline __device__ __host__ typename std::enable_if<Accessor::supports_ghost_zone, void>::type
    load(const Accessor &a, int d, int parity, int x_cb, int si, int sj, int i0, int j0)
    {
#pragma unroll
      for (int i = 0; i < m; i++) {
#pragma unroll
...
#pragma unroll
      for (int i = 0; i < m; i++) {
#pragma unroll
        for (int j = 0; j < n; j++) { tile[i * n + j] = a(d, parity, x_cb, si, sj, i0 + i, j0 + j); }
      }
    }

    template <typename Accessor>
    inline __device__ __host__ void save(Accessor &a, int d, int parity, int x_cb, int i0, int j0)
    {
#pragma unroll
      for (int i = 0; i < m; i++) {
#pragma unroll
    ...
    template <typename Accessor>
    inline __device__ __host__ void save(Accessor &a, int d, int parity, int x_cb, int si, int sj, int i0, int j0)
    {
#pragma unroll
      for (int i = 0; i < m; i++) {
#pragma unroll
    ...
    template <typename Accessor>
    inline __device__ __host__ void loadCS(const Accessor &a, int d, int dir, int parity, int x_cb, int s, int i0, int j0)
    {
#pragma unroll
      for (int i = 0; i < m; i++) {
#pragma unroll
    ...
    template <typename Accessor>
    inline __device__ __host__ void saveCS(Accessor &a, int d, int dir, int parity, int x_cb, int s, int i0, int j0)
    {
#pragma unroll
      for (int i = 0; i < m; i++) {
#pragma unroll
...
#pragma unroll
      for (int i = 0; i < m; i++) {
#pragma unroll
        for (int j = 0; j < n; j++) { max = fmax(max, maxTile[i * n + j]); }
      }
      return max;
    }
  };
