...
//////*************************************************************************************************/////////
void performGaussianSmearNStep2(void **prop_array, QudaInvertParam *inv_param, const int n_steps, const double width)
{
  if(n_steps == 0) return;
  ...
  const double ftmp = -(width*width)/(4*iters*4);  /* Extra 4 to compensate for stride 2 */
  const double ftmpinv = 1. / ftmp;  
