...
/*! 
 * \brief Multi Shift Solver for staggered fermions
 *
 * The offsets[0] is folded into the mass of the 'mat' operator
 ...
 * 
 * The matrix mass is 'unmodified'. THe lowest offset is in offsets[0]
 *
 */

int invertMultiShiftCgCudaGeneric(const DiracMatrix &mat, 
