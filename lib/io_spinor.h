...
#define READ_1ST_NBR_SPINOR_DOUBLE(spinor, idx)			\
    double2 I0 = fetch_double2((spinor), idx + 0*sp_stride);    \
    double2 I1 = fetch_double2((spinor), idx + 1*sp_stride);    \
    double2 I2 = fetch_double2((spinor), idx + 2*sp_stride);

#define READ_3RD_NBR_SPINOR_DOUBLE(spinor, idx)			\
    double2 T0 = fetch_double2((spinor), idx + 0*sp_stride);	\
