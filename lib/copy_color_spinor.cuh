  ...
  public:
    ...
    void apply(const qudaStream_t &stream)
    {
      ...
      if constexpr (nSpin == 4) {
        ...
        } else if (out.GammaBasis() == QUDA_OPENQCD_GAMMA_BASIS && in.GammaBasis() == QUDA_DEGRAND_ROSSI_GAMMA_BASIS) {
          launch<CopyColorSpinor_, enable_host>(tp, stream, Arg<DegrandRossiToOpenqcd>(out, in, Out_, In_));
