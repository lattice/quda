...
namespace quda
{
  ...
  namespace mma
  {
    ...
    launch_compute_uv_kernel(TuneParam &tp, const Arg &arg, int min_threads, const cudaStream_t &stream)
    {
      ...
      case 5: launch_compute_uv_kernel<from_coarse,  48,  32,  24,  16,  12>(tp, arg, min_threads, stream); break;
      case 6: launch_compute_uv_kernel<from_coarse,  48,  32,  24,  16,  12>(tp, arg, min_threads, stream); break;
      case 7: launch_compute_uv_kernel<from_coarse,  48,  32,  24,  16,  12>(tp, arg, min_threads, stream); break;
    ...
    launch_compute_uv_kernel(TuneParam &tp, const Arg &arg, int min_threads, const cudaStream_t &stream)
    {
      ...
      case 6: launch_compute_uv_kernel<from_coarse,  48,  64,  24,  16,  24>(tp, arg, min_threads, stream); break;
      case 7: launch_compute_uv_kernel<from_coarse,  48,  64,  24,  16,  24>(tp, arg, min_threads, stream); break;
      default: errorQuda("tp.aux.x(=%d) is NOT supported by (%d, %d, %d, %d).", tp.aux.x, Arg::fineSpin, Arg::coarseSpin, Arg::fineColor, Arg::coarseColor);
      }
      // clang-format on
    }
    ...
    launch_compute_uv_kernel(TuneParam &tp, const Arg &arg, int min_threads, const cudaStream_t &stream)
    {
      ...
      case 3: launch_compute_uv_kernel<from_coarse,  64,  32,  32,  16,  16>(tp, arg, min_threads, stream); break;
      case 4: launch_compute_uv_kernel<from_coarse,  64,  32,  32,  16,  16>(tp, arg, min_threads, stream); break;
      case 5: launch_compute_uv_kernel<from_coarse,  64,  32,  32,  16,  16>(tp, arg, min_threads, stream); break;
      case 6: launch_compute_uv_kernel<from_coarse,  64,  32,  32,  16,  16>(tp, arg, min_threads, stream); break;
      case 7: launch_compute_uv_kernel<from_coarse,  64,  32,  32,  16,  16>(tp, arg, min_threads, stream); break;
      default: errorQuda("tp.aux.x(=%d) is NOT supported by (%d, %d, %d, %d).", tp.aux.x, Arg::fineSpin, Arg::coarseSpin, Arg::fineColor, Arg::coarseColor);
      }
      // clang-format on
    }
    ...
    launch_compute_uv_kernel(TuneParam &tp, const Arg &arg, int min_threads, const cudaStream_t &stream)
    {
      ...
      case 7: launch_compute_uv_kernel<from_coarse, 128,  64,  64,  32,  16>(tp, arg, min_threads, stream); break;
      default: errorQuda("tp.aux.x(=%d) is NOT supported by (%d, %d, %d, %d).", tp.aux.x, Arg::fineSpin, Arg::coarseSpin, Arg::fineColor, Arg::coarseColor);
      }
      // clang-format on
    }
    ...
    launch_compute_uv_kernel(TuneParam &tp, const Arg &arg, int min_threads, const cudaStream_t &stream)
    {
      ...
      case 4: launch_compute_uv_kernel<from_coarse, 192,  96,  96,  16,  12>(tp, arg, min_threads, stream); break;
      case 5: launch_compute_uv_kernel<from_coarse, 192,  96,  96,  24,  12>(tp, arg, min_threads, stream); break;
      case 6: launch_compute_uv_kernel<from_coarse, 192,  96,  96,  24,  24>(tp, arg, min_threads, stream); break;
      case 7: launch_compute_uv_kernel<from_coarse, 192,  96,  96,  24,  24>(tp, arg, min_threads, stream); break;
      default: errorQuda("tp.aux.x(=%d) is NOT supported by (%d, %d, %d, %d).", tp.aux.x, Arg::fineSpin, Arg::coarseSpin, Arg::fineColor, Arg::coarseColor);
      }
      // clang-format on
    }
    ...
    launch_compute_vuv_kernel(TuneParam &tp, const Arg &arg, int min_threads, const cudaStream_t &stream)
    {
      ...
      case 5: launch_compute_vuv_kernel<from_coarse,  32,  32,  24,  32,   4>(tp, arg, min_threads, stream); break;
      case 6: launch_compute_vuv_kernel<from_coarse,  32,  32,  24,  32,   4>(tp, arg, min_threads, stream); break;
      case 7: launch_compute_vuv_kernel<from_coarse,  32,  32,  24,  32,   4>(tp, arg, min_threads, stream); break;
      default: errorQuda("tp.aux.x(=%d) is NOT supported by (%d, %d, %d, %d).", tp.aux.x, Arg::fineSpin, Arg::coarseSpin, Arg::fineColor, Arg::coarseColor);
      }
      // clang-format on
    }
    ...
    launch_compute_vuv_kernel(TuneParam &tp, const Arg &arg, int min_threads, const cudaStream_t &stream)
    {
      ...
      case 4: launch_compute_vuv_kernel<from_coarse,  32,  32,  32,  32,   4>(tp, arg, min_threads, stream); break;
      case 5: launch_compute_vuv_kernel<from_coarse,  32,  32,  32,  32,   4>(tp, arg, min_threads, stream); break;
      case 6: launch_compute_vuv_kernel<from_coarse,  32,  32,  32,  32,   4>(tp, arg, min_threads, stream); break;
      case 7: launch_compute_vuv_kernel<from_coarse,  32,  32,  32,  32,   4>(tp, arg, min_threads, stream); break;
      default: errorQuda("tp.aux.x(=%d) is NOT supported by (%d, %d, %d, %d).", tp.aux.x, Arg::fineSpin, Arg::coarseSpin, Arg::fineColor, Arg::coarseColor);
      }
      // clang-format on
    }
    ...
    launch_compute_vuv_kernel(TuneParam &tp, const Arg &arg, int min_threads, const cudaStream_t &stream)
    {
      ...
      case 7: launch_compute_vuv_kernel<from_coarse,  96,  96,  64,  32,   6>(tp, arg, min_threads, stream); break;
      default: errorQuda("tp.aux.x(=%d) is NOT supported by (%d, %d, %d, %d).", tp.aux.x, Arg::fineSpin, Arg::coarseSpin, Arg::fineColor, Arg::coarseColor);
      }
      // clang-format on
    }
    ...
    launch_compute_vuv_kernel(TuneParam &tp, const Arg &arg, int min_threads, const cudaStream_t &stream)
    {
      ...
      case 7: launch_compute_vuv_kernel<from_coarse,  96,  96,  96,  24,  24>(tp, arg, min_threads, stream); break;
      default: errorQuda("tp.aux.x(=%d) is NOT supported by (%d, %d, %d, %d).", tp.aux.x, Arg::fineSpin, Arg::coarseSpin, Arg::fineColor, Arg::coarseColor);
      }
      // clang-format on
    }
      ...
      Launch(Arg &arg, CUresult &error, TuneParam &tp, ComputeType type, int min_threads, const cudaStream_t &stream)
      {
        ...
        if (type == COMPUTE_UV) {
          ...
          if (!activeTuning()) { // only do reduction once tuning is done else we have nested tuning
            double max = reduce(QUDA_CUDA_FIELD_LOCATION, arg.max_d, 2 * arg.fineVolumeCB, static_cast<Float>(0.0),
                                maximum<Float>());
    ...
    protected:
      ...
      long long flops() const
      {
        ...
        case COMPUTE_UV:
          ...
          flops_
            = 2l * arg.fineVolumeCB * 8 * fineSpin * coarseColor * fineColor * fineColor * (!from_coarse ? 1 : fineSpin);
          break;
        case COMPUTE_AV:
        case COMPUTE_TMAV:
        ...
        case COMPUTE_VUV:
          ...
          flops_ = 2l * arg.fineVolumeCB * 8 * fineSpin * fineSpin * coarseColor * coarseColor * fineColor
      ...
      long long bytes() const
      {
        long long bytes_ = 0;
        switch (type) {
        case COMPUTE_UV: bytes_ = arg.UV.Bytes() + arg.V.Bytes() + 2 * arg.U.Bytes() * coarseColor; break;
        case COMPUTE_AV: bytes_ = arg.AV.Bytes() + arg.V.Bytes() + 2 * arg.C.Bytes() * coarseColor; break;
        case COMPUTE_TMAV: bytes_ = arg.AV.Bytes() + arg.V.Bytes(); break;
        case COMPUTE_TMCAV:
        ...
        case COMPUTE_VUV: {
          ...
          bytes_ = 2 * writes * arg.Y.Bytes() + (arg.bidirectional ? 1 : 2) * 2 * writes * arg.X.Bytes()
            + coarseColor * (arg.UV.Bytes() + arg.V.Bytes());
          break;
        }
        case COMPUTE_COARSE_CLOVER:
          bytes_ = 2 * arg.X.Bytes() + 2 * arg.C.Bytes() + arg.V.Bytes(); // 2 from parity
          break;
        case COMPUTE_REVERSE_Y: bytes_ = 4 * 2 * 2 * arg.Y.Bytes(); // 4 from direction, 2 from i/o, 2 from parity
        case COMPUTE_DIAGONAL:
        case COMPUTE_TMDIAGONAL:
    ...
    public:
      ...
      void apply(const cudaStream_t &stream)
      {
        ...
        arg.dim = dim;
        arg.dir = dir;
        if (type == COMPUTE_VUV || type == COMPUTE_CONVERT || type == COMPUTE_RESCALE)
      ...
      {
        return ((!arg.shared_atomic && !from_coarse && type == COMPUTE_VUV) || type == COMPUTE_COARSE_CLOVER) ?
          false :
      ...
      TuneKey tuneKey() const
      {
        ...
        const char *vol_str = (type == COMPUTE_REVERSE_Y || type == COMPUTE_DIAGONAL || type == COMPUTE_TMDIAGONAL
                               || type == COMPUTE_CONVERT || type == COMPUTE_RESCALE) ?
          X.VolString() :
          meta.VolString();

        if (type == COMPUTE_VUV || type == COMPUTE_COARSE_CLOVER) {
          strcat(Aux,
                 (meta.Location() == QUDA_CUDA_FIELD_LOCATION && Y.MemType() == QUDA_MEMORY_MAPPED) ?
                   ",GPU-mapped," :
      ...
      {
        switch (type) {
        case COMPUTE_VUV: Y_atomic.backup();
        case COMPUTE_DIAGONAL:
        case COMPUTE_TMDIAGONAL:
      ...
      {
        switch (type) {
        case COMPUTE_VUV: Y_atomic.restore();
        case COMPUTE_DIAGONAL:
        case COMPUTE_TMDIAGONAL:
        ...
        case COMPUTE_CONVERT:
          ...
          break;
        case COMPUTE_RESCALE: Y.restore();
        case COMPUTE_UV:
        case COMPUTE_AV:
        case COMPUTE_TMAV:
        case COMPUTE_TMCAV:
                    ...
                    const int *fine_to_coarse, const int *coarse_to_fine)
    {
      ...
      bool bidirectional_links
        = (dirac == QUDA_CLOVERPC_DIRAC || dirac == QUDA_COARSEPC_DIRAC || bidirectional_debug
      ...
      typedef CalculateYArg<Float, fineSpin, coarseSpin, fineColor, coarseColor, coarseGauge, coarseGaugeAtomic,
                            fineGauge, F, Ftmp, Vt, fineClover>
        Arg;
      Arg arg(Y, X, Y_atomic, X_atomic, UV, AV, G, V, C, Cinv, kappa, mu, mu_factor, x_size, xc_size, geo_bs, spin_bs,
              fine_to_coarse, coarse_to_fine, bidirectional_links);
      CalculateY<location, from_coarse, Float, fineSpin, fineColor, coarseSpin, coarseColor, Arg> y(
        arg, v, Y_, X_, Y_atomic_, X_atomic_);
        ...
        for (int d = 0; d < nDim; d++) {
          ...
          if (getVerbosity() >= QUDA_VERBOSE)
            printfQuda("Y2[%d] (atomic) = %e\n", 4 + d,
                       Y_atomic_.norm2((4 + d) % arg.Y_atomic.geometry, coarseGaugeAtomic::fixedPoint()));
          ...
          if (coarseGaugeAtomic::fixedPoint() || coarseGauge::fixedPoint()) {
            ...
            if (coarseGauge::fixedPoint()) {
              ...
              if (getVerbosity() >= QUDA_DEBUG_VERBOSE)
                printfQuda("Y[%d] (atomic) max = %e Y[%d] scale = %e\n", 4 + d, y_max, 4 + d, Y_.Scale());
              if (!set_scale) {
      ...
      for (int d = 0; d < nDim; d++) {
        ...
        if (getVerbosity() >= QUDA_VERBOSE)
          printfQuda("Y2[%d] (atomic) = %e\n", d,
                     Y_atomic_.norm2(d % arg.Y_atomic.geometry, coarseGaugeAtomic::fixedPoint()));
