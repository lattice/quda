...
#include <tmc_ndeg_dslash_def.h>       // Twisted Clover kernels
#endif
...
#include <dslash_events.cuh>
  ...
  using namespace ndegtwistedclover;

#ifdef GPU_NDEG_TWISTED_CLOVER_DIRAC
  template <typename sFloat, typename gFloat, typename cFloat>
  class NdegTwistedCloverDslashCuda : public SharedDslashCuda {
  ...
  public:
    NdegTwistedCloverDslashCuda(cudaColorSpinorField *out, const gFloat *gauge0, const gFloat *gauge1, 
				...
				const double epsilon, const double kappa, const double k, const int dagger)
    ...
    { 
      ...
      switch(dslashType){
      case QUDA_NDEG_CLOVER_TWIST_INV_DSLASH:
#ifdef MULTI_GPU 
#ifndef DYNAMIC_CLOVER
        fillAux(INTERIOR_KERNEL, "type=interior,NdegCloverTwistInvDslash");
        fillAux(EXTERIOR_KERNEL_ALL, "type=exterior_all,NdegCloverTwistInvDslash");
        fillAux(EXTERIOR_KERNEL_X, "type=exterior_x,NdegCloverTwistInvDslash");
        fillAux(EXTERIOR_KERNEL_Y, "type=exterior_y,NdegCloverTwistInvDslash");
        fillAux(EXTERIOR_KERNEL_Z, "type=exterior_z,NdegCloverTwistInvDslash");
        fillAux(EXTERIOR_KERNEL_T, "type=exterior_t,NdegCloverTwistInvDslash");
#else
        fillAux(INTERIOR_KERNEL, "type=interior,NdegCloverTwistInvDynDslash");
        fillAux(EXTERIOR_KERNEL_ALL, "type=exterior_all,NdegCloverTwistInvDynDslash");
        fillAux(EXTERIOR_KERNEL_X, "type=exterior_x,NdegCloverTwistInvDynDslash");
        fillAux(EXTERIOR_KERNEL_Y, "type=exterior_y,NdegCloverTwistInvDynDslash");
        fillAux(EXTERIOR_KERNEL_Z, "type=exterior_z,NdegCloverTwistInvDynDslash");
        fillAux(EXTERIOR_KERNEL_T, "type=exterior_t,NdegCloverTwistInvDynDslash");
#endif // DYNAMIC_CLOVER
#else
#ifndef DYNAMIC_CLOVER
        fillAux(INTERIOR_KERNEL, "type=single-GPU,NdegCloverTwistInvDslash");
#else
        fillAux(INTERIOR_KERNEL, "type=single-GPU,NdegCloverTwistInvDynDslash");
#endif // DYNAMIC_CLOVER
#endif // MULTI_GPU
        break;

      case QUDA_NDEG_DSLASH_CLOVER_TWIST_INV:
#ifdef MULTI_GPU
#ifndef DYNAMIC_CLOVER
        fillAux(INTERIOR_KERNEL, "type=interior,NdegDslash");
        fillAux(EXTERIOR_KERNEL_ALL, "type=exterior_all,NdegDslash");
        fillAux(EXTERIOR_KERNEL_X, "type=exterior_x,NdegDslash");
        fillAux(EXTERIOR_KERNEL_Y, "type=exterior_y,NdegDslash");
        fillAux(EXTERIOR_KERNEL_Z, "type=exterior_z,NdegDslash");
        fillAux(EXTERIOR_KERNEL_T, "type=exterior_t,NdegDslash");
#else
        fillAux(INTERIOR_KERNEL, "type=interior,NdegDynDslash");
        fillAux(EXTERIOR_KERNEL_ALL, "type=exterior_all,NdegDynDslash");
        fillAux(EXTERIOR_KERNEL_X, "type=exterior_x,NdegDynDslash");
        fillAux(EXTERIOR_KERNEL_Y, "type=exterior_y,NdegDynDslash");
        fillAux(EXTERIOR_KERNEL_Z, "type=exterior_z,NdegDynDslash");
        fillAux(EXTERIOR_KERNEL_T, "type=exterior_t,NdegDynDslash");
#endif // DYNAMIC_CLOVER
#else
#ifndef DYNAMIC_CLOVER
        fillAux(INTERIOR_KERNEL, "type=single-GPU,NdegDslash");
#else
        fillAux(INTERIOR_KERNEL, "type=single-GPU,NdegDynDslash");
#endif // DYNAMIC_CLOVER
#endif // MULTI_GPU
        break;

      case QUDA_NDEG_DSLASH_CLOVER_TWIST_XPAY:
#ifdef MULTI_GPU 
#ifndef DYNAMIC_CLOVER
        fillAux(INTERIOR_KERNEL, "type=interior,NdegDslashCloverTwist");
        fillAux(EXTERIOR_KERNEL_ALL, "type=exterior_all,NdegDslashCloverTwist");
        fillAux(EXTERIOR_KERNEL_X, "type=exterior_x,NdegDslashCloverTwist");
        fillAux(EXTERIOR_KERNEL_Y, "type=exterior_y,NdegDslashCloverTwist");
        fillAux(EXTERIOR_KERNEL_Z, "type=exterior_z,NdegDslashCloverTwist");
        fillAux(EXTERIOR_KERNEL_T, "type=exterior_t,NdegDslashCloverTwist");
#else
        fillAux(INTERIOR_KERNEL, "type=interior,NdegDynDslashCloverTwist");
        fillAux(EXTERIOR_KERNEL_ALL, "type=exterior_all,NdegDynDslashCloverTwist");
        fillAux(EXTERIOR_KERNEL_X, "type=exterior_x,NdegDynDslashCloverTwist");
        fillAux(EXTERIOR_KERNEL_Y, "type=exterior_y,NdegDynDslashCloverTwist");
        fillAux(EXTERIOR_KERNEL_Z, "type=exterior_z,NdegDynDslashCloverTwist");
        fillAux(EXTERIOR_KERNEL_T, "type=exterior_t,NdegDynDslashCloverTwist");
#endif // DYNAMIC_CLOVER
#else
#ifndef DYNAMIC_CLOVER
        fillAux(INTERIOR_KERNEL, "type=single-GPU,NdegDslashCloverTwist");
#else
        fillAux(INTERIOR_KERNEL, "type=single-GPU,NdegDynDslashCloverTwist");
#endif // DYNAMIC_CLOVER
#endif // MULTI_GPU
        break;
      default:
	errorQuda("Unsupported non-degenerate twisted-clover dslash type %d", dslashType);
      }
    }

    virtual ~NdegTwistedCloverDslashCuda() { unbindSpinorTex<sFloat>(in, out, x); }
	...
	errorQuda("Shared dslash does not yet support X-dimension partitioning");
      ...
      switch(dslashType){
      case QUDA_NDEG_CLOVER_TWIST_INV_DSLASH:
	DSLASH(twistedNdegCloverInvDslash, tp.grid, tp.block, tp.shared_bytes, stream, dslashParam);
	break;
      case QUDA_NDEG_DSLASH_CLOVER_TWIST_INV:
	DSLASH(twistedNdegCloverDslash, tp.grid, tp.block, tp.shared_bytes, stream, dslashParam);
	break;
      case QUDA_NDEG_DSLASH_CLOVER_TWIST_XPAY:
	DSLASH(twistedNdegCloverDslashTwist, tp.grid, tp.block, tp.shared_bytes, stream, dslashParam);
	break;
      default:
	errorQuda("Invalid non-degenerate twisted clover dslash type");
      }
    }

    long long flops() const {
      int clover_flops = (504 + 48)*2;	//FIXME Fix-me
