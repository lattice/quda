...
//single precision, 12-reconstruct for site link
...
#define RECONSTRUCT_SITE_LINK(dir, idx, sign, var)  RECONSTRUCT_LINK_12_SINGLE(dir, idx, sign, var);
