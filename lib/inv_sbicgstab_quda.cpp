...
namespace quda {
  ...
  void SimpleBiCGstab::operator()(ColorSpinorField &x, ColorSpinorField &b)
  {
    ...
    ColorSpinorField A2p(r);
    ColorSpinorField Ar(r);
    ColorSpinorField r_new(r);
    ColorSpinorField p_new(r);
    Complex r0r;
    Complex alpha;
    Complex omega;
    Complex beta;
