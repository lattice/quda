...
#define READ_LONG_MATRIX_8_DOUBLE(gauge, dir, idx)                      \
    ...
    double2 LONG1 = fetch_double2((gauge), idx + ((dir/2)*4+1)*ga_stride); \
    double2 LONG2 = fetch_double2((gauge), idx + ((dir/2)*4+2)*ga_stride); \
    double2 LONG3 = fetch_double2((gauge), idx + ((dir/2)*4+3)*ga_stride); \
