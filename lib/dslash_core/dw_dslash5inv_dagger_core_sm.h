...
p00_re[ coord[4]*blockDim.x+threadIdx.x ] = i00_re;
p00_im[ coord[4]*blockDim.x+threadIdx.x ] = i00_im;
p01_re[ coord[4]*blockDim.x+threadIdx.x ] = i01_re;
p01_im[ coord[4]*blockDim.x+threadIdx.x ] = i01_im;
p02_re[ coord[4]*blockDim.x+threadIdx.x ] = i02_re;
p02_im[ coord[4]*blockDim.x+threadIdx.x ] = i02_im;
p10_re[ coord[4]*blockDim.x+threadIdx.x ] = i10_re;
p10_im[ coord[4]*blockDim.x+threadIdx.x ] = i10_im;
p11_re[ coord[4]*blockDim.x+threadIdx.x ] = i11_re;
p11_im[ coord[4]*blockDim.x+threadIdx.x ] = i11_im;
p12_re[ coord[4]*blockDim.x+threadIdx.x ] = i12_re;
p12_im[ coord[4]*blockDim.x+threadIdx.x ] = i12_im;
p20_re[ coord[4]*blockDim.x+threadIdx.x ] = i20_re;
p20_im[ coord[4]*blockDim.x+threadIdx.x ] = i20_im;
p21_re[ coord[4]*blockDim.x+threadIdx.x ] = i21_re;
p21_im[ coord[4]*blockDim.x+threadIdx.x ] = i21_im;
p22_re[ coord[4]*blockDim.x+threadIdx.x ] = i22_re;
p22_im[ coord[4]*blockDim.x+threadIdx.x ] = i22_im;
p30_re[ coord[4]*blockDim.x+threadIdx.x ] = i30_re;
p30_im[ coord[4]*blockDim.x+threadIdx.x ] = i30_im;
p31_re[ coord[4]*blockDim.x+threadIdx.x ] = i31_re;
p31_im[ coord[4]*blockDim.x+threadIdx.x ] = i31_im;
p32_re[ coord[4]*blockDim.x+threadIdx.x ] = i32_re;
p32_im[ coord[4]*blockDim.x+threadIdx.x ] = i32_im;
...
//    READ_SPINOR( SPINORTEX, param.sp_stride, sp_idx, sp_idx );
		...
		o00_re += factorR*(p00_re[s*blockDim.x+threadIdx.x] + p20_re[s*blockDim.x+threadIdx.x]);
    o00_im += factorR*(p00_im[s*blockDim.x+threadIdx.x] + p20_im[s*blockDim.x+threadIdx.x]);
    o20_re += factorR*(p00_re[s*blockDim.x+threadIdx.x] + p20_re[s*blockDim.x+threadIdx.x]);
    o20_im += factorR*(p00_im[s*blockDim.x+threadIdx.x] + p20_im[s*blockDim.x+threadIdx.x]);
    o01_re += factorR*(p01_re[s*blockDim.x+threadIdx.x] + p21_re[s*blockDim.x+threadIdx.x]);
    o01_im += factorR*(p01_im[s*blockDim.x+threadIdx.x] + p21_im[s*blockDim.x+threadIdx.x]);
    o21_re += factorR*(p01_re[s*blockDim.x+threadIdx.x] + p21_re[s*blockDim.x+threadIdx.x]);
    o21_im += factorR*(p01_im[s*blockDim.x+threadIdx.x] + p21_im[s*blockDim.x+threadIdx.x]);
    o02_re += factorR*(p02_re[s*blockDim.x+threadIdx.x] + p22_re[s*blockDim.x+threadIdx.x]);
    o02_im += factorR*(p02_im[s*blockDim.x+threadIdx.x] + p22_im[s*blockDim.x+threadIdx.x]);
    o22_re += factorR*(p02_re[s*blockDim.x+threadIdx.x] + p22_re[s*blockDim.x+threadIdx.x]);
    o22_im += factorR*(p02_im[s*blockDim.x+threadIdx.x] + p22_im[s*blockDim.x+threadIdx.x]);
    o10_re += factorR*(p10_re[s*blockDim.x+threadIdx.x] + p30_re[s*blockDim.x+threadIdx.x]);
    o10_im += factorR*(p10_im[s*blockDim.x+threadIdx.x] + p30_im[s*blockDim.x+threadIdx.x]);
    o30_re += factorR*(p10_re[s*blockDim.x+threadIdx.x] + p30_re[s*blockDim.x+threadIdx.x]);
    o30_im += factorR*(p10_im[s*blockDim.x+threadIdx.x] + p30_im[s*blockDim.x+threadIdx.x]);
    o11_re += factorR*(p11_re[s*blockDim.x+threadIdx.x] + p31_re[s*blockDim.x+threadIdx.x]);
    o11_im += factorR*(p11_im[s*blockDim.x+threadIdx.x] + p31_im[s*blockDim.x+threadIdx.x]);
    o31_re += factorR*(p11_re[s*blockDim.x+threadIdx.x] + p31_re[s*blockDim.x+threadIdx.x]);
    o31_im += factorR*(p11_im[s*blockDim.x+threadIdx.x] + p31_im[s*blockDim.x+threadIdx.x]);
    o12_re += factorR*(p12_re[s*blockDim.x+threadIdx.x] + p32_re[s*blockDim.x+threadIdx.x]);
    o12_im += factorR*(p12_im[s*blockDim.x+threadIdx.x] + p32_im[s*blockDim.x+threadIdx.x]);
    o32_re += factorR*(p12_re[s*blockDim.x+threadIdx.x] + p32_re[s*blockDim.x+threadIdx.x]);
    o32_im += factorR*(p12_im[s*blockDim.x+threadIdx.x] + p32_im[s*blockDim.x+threadIdx.x]);
...
//    o32_im += factorR*(i12_im + i32_im);
    ...
    factorL = inv_d_n * POW(kappa,exponent2) * ( coord[4] < s ? -mferm : static_cast<spinorFloat>(1.0));
		...
		o00_re += factorL*(p00_re[s*blockDim.x+threadIdx.x] - p20_re[s*blockDim.x+threadIdx.x]);
    o00_im += factorL*(p00_im[s*blockDim.x+threadIdx.x] - p20_im[s*blockDim.x+threadIdx.x]);
    o01_re += factorL*(p01_re[s*blockDim.x+threadIdx.x] - p21_re[s*blockDim.x+threadIdx.x]);
    o01_im += factorL*(p01_im[s*blockDim.x+threadIdx.x] - p21_im[s*blockDim.x+threadIdx.x]);
    o02_re += factorL*(p02_re[s*blockDim.x+threadIdx.x] - p22_re[s*blockDim.x+threadIdx.x]);
    o02_im += factorL*(p02_im[s*blockDim.x+threadIdx.x] - p22_im[s*blockDim.x+threadIdx.x]);
    o10_re += factorL*(p10_re[s*blockDim.x+threadIdx.x] - p30_re[s*blockDim.x+threadIdx.x]);
    o10_im += factorL*(p10_im[s*blockDim.x+threadIdx.x] - p30_im[s*blockDim.x+threadIdx.x]);
    o11_re += factorL*(p11_re[s*blockDim.x+threadIdx.x] - p31_re[s*blockDim.x+threadIdx.x]);
    o11_im += factorL*(p11_im[s*blockDim.x+threadIdx.x] - p31_im[s*blockDim.x+threadIdx.x]);
    o12_re += factorL*(p12_re[s*blockDim.x+threadIdx.x] - p32_re[s*blockDim.x+threadIdx.x]);
    o12_im += factorL*(p12_im[s*blockDim.x+threadIdx.x] - p32_im[s*blockDim.x+threadIdx.x]);
    o20_re += factorL*(p20_re[s*blockDim.x+threadIdx.x] - p00_re[s*blockDim.x+threadIdx.x]);
    o20_im += factorL*(p20_im[s*blockDim.x+threadIdx.x] - p00_im[s*blockDim.x+threadIdx.x]);
    o21_re += factorL*(p21_re[s*blockDim.x+threadIdx.x] - p01_re[s*blockDim.x+threadIdx.x]);
    o21_im += factorL*(p21_im[s*blockDim.x+threadIdx.x] - p01_im[s*blockDim.x+threadIdx.x]);
    o22_re += factorL*(p22_re[s*blockDim.x+threadIdx.x] - p02_re[s*blockDim.x+threadIdx.x]);
    o22_im += factorL*(p22_im[s*blockDim.x+threadIdx.x] - p02_im[s*blockDim.x+threadIdx.x]);
    o30_re += factorL*(p30_re[s*blockDim.x+threadIdx.x] - p10_re[s*blockDim.x+threadIdx.x]);
    o30_im += factorL*(p30_im[s*blockDim.x+threadIdx.x] - p10_im[s*blockDim.x+threadIdx.x]);
    o31_re += factorL*(p31_re[s*blockDim.x+threadIdx.x] - p11_re[s*blockDim.x+threadIdx.x]);
    o31_im += factorL*(p31_im[s*blockDim.x+threadIdx.x] - p11_im[s*blockDim.x+threadIdx.x]);
    o32_re += factorL*(p32_re[s*blockDim.x+threadIdx.x] - p12_re[s*blockDim.x+threadIdx.x]);
    o32_im += factorL*(p32_im[s*blockDim.x+threadIdx.x] - p12_im[s*blockDim.x+threadIdx.x]);
