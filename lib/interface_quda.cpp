              ...
              for(int i=0; i<diracParam.Ls; i++)
                  {
                      printfQuda("fromQUDA diracParam: b5[%d] = %f + i%f, c5[%d] = %f + i%f\n",
                                 i, diracParam.b_5[i].real(), diracParam.b_5[i].imag(), i, diracParam.c_5[i].real(), diracParam.c_5[i].imag());
                      //printfQuda("fromQUDA inv_param: b5[%d] = %f %f c5[%d] = %f %f\n", i, inv_param->b_5[i], i, inv_param->c_5[i] );
                      //printfQuda("fromQUDA creal: b5[%d] = %f %f c5[%d] = %f %f \n", i, creal(inv_param->b_5[i]), cimag(inv_param->b_5[i]), i, creal(inv_param->c_5[i]), cimag(inv_param->c_5[i]) );
                  }
          }
      break;
