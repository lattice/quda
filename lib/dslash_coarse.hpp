...
namespace quda {
  ...
  template <bool dagger, int coarseColor> struct CoarseDslashD {
  ...
  void ApplyCoarse_t(cvector_ref<ColorSpinorField> &out, cvector_ref<const ColorSpinorField> &inA,
                     ...
                     const ColorSpinorField &halo)
  {
    ApplyCoarse<CoarseDslashD<dagger, coarseColor>::template D, Float, yFloat, ghostFloat, dagger, coarseColor, false, 1>(
