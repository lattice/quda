...
namespace quda {
  ...
  GaugeField::GaugeField(const GaugeFieldParam &param) :
    ...
    staggeredPhaseType(param.staggeredPhaseType), staggeredPhaseApplied(param.staggeredPhaseApplied), staggered_u1_emulation(param.staggered_u1_emulation), staggered_2link_term(param.staggered_2link_term), omega(param.omega), i_mu(param.i_mu)
  {
