...
namespace quda {
  ...
  void copyGauge(const InOrder &inOrder, GaugeField &out, const GaugeField &in, QudaFieldLocation location,
                 FloatOut *Out, FloatOut **outGhost, int type, double scale)
  {
    if (out.isNative()) {
  ...
  void copyGauge(GaugeField &out, const GaugeField &in, QudaFieldLocation location, FloatOut *Out, FloatIn *In,
                 FloatOut **outGhost, FloatIn **inGhost, int type, double scale)
  {
    ...
    if (in.isNative()) {
      if (in.Reconstruct() == QUDA_RECONSTRUCT_NO) {
        ...
        copyGauge<FloatOut, FloatIn, length>(G(in, In, inGhost), out, in, location, Out, outGhost, type, scale);
...
#ifdef BUILD_QDP_INTERFACE
      copyGauge<FloatOut, FloatIn, length>(QDPOrder<FloatIn, length>(in, In, inGhost), out, in, location, Out, outGhost,
                                           type, scale);
#else
      errorQuda("QDP interface has not been built\n");
#endif
...
#ifdef BUILD_QDPJIT_INTERFACE
      copyGauge<FloatOut, FloatIn, length>(QDPJITOrder<FloatIn, length>(in, In, inGhost), out, in, location, Out,
                                           outGhost, type, scale);
#else
      errorQuda("QDPJIT interface has not been built\n");
#endif
...
#ifdef BUILD_CPS_INTERFACE
      copyGauge<FloatOut, FloatIn, length>(CPSOrder<FloatIn, length>(in, In, inGhost), out, in, location, Out, outGhost,
                                           type, scale);
#else
      errorQuda("CPS interface has not been built\n");
#endif
...
#ifdef BUILD_MILC_INTERFACE
      copyGauge<FloatOut, FloatIn, length>(MILCOrder<FloatIn, length>(in, In, inGhost), out, in, location, Out,
                                           outGhost, type, scale);
#else
      errorQuda("MILC interface has not been built\n");
#endif
...
#ifdef BUILD_MILC_INTERFACE
      copyGauge<FloatOut, FloatIn, length>(MILCSiteOrder<FloatIn, length>(in, In, inGhost), out, in, location, Out,
                                           outGhost, type, scale);
#else
      errorQuda("MILC interface has not been built\n");
#endif
...
#ifdef BUILD_BQCD_INTERFACE
      copyGauge<FloatOut, FloatIn, length>(BQCDOrder<FloatIn, length>(in, In, inGhost), out, in, location, Out,
                                           outGhost, type, scale);
#else
      errorQuda("BQCD interface has not been built\n");
#endif
...
#ifdef BUILD_TIFR_INTERFACE
      copyGauge<FloatOut, FloatIn, length>(TIFROrder<FloatIn, length>(in, In, inGhost), out, in, location, Out,
                                           outGhost, type, scale);
#else
      errorQuda("TIFR interface has not been built\n");
#endif
...
#ifdef BUILD_TIFR_INTERFACE
      copyGauge<FloatOut, FloatIn, length>(TIFRPaddedOrder<FloatIn, length>(in, In, inGhost), out, in, location, Out,
                                           outGhost, type, scale);
#else
      errorQuda("TIFR interface has not been built\n");
#endif
  ...
  template <typename FloatOut, typename FloatIn> struct GaugeCopy {
              ...
              void **outGhost_, void **inGhost_, int type)
    {
      ...
      if (in.LinkType() != QUDA_ASQTAD_MOM_LINKS && out.LinkType() != QUDA_ASQTAD_MOM_LINKS) {
        ...
        copyGauge<FloatOut, FloatIn, 18>(out, in, location, Out, In, outGhost, inGhost, type, scale);
      } else {
        checkMomOrder(in);
        checkMomOrder(out);
