...
void axpbyCuda(double a, ParitySpinor x, double b, ParitySpinor y) {
  ...
  if (x.precision == QUDA_DOUBLE_PRECISION) {
    ...
    axpbyKernel<<<blasGrid, blasBlock>>>((float)a, (float2*)x.spinor, (float)b, (float2*)y.spinor, x.length/2);
  } else {
    ...
    blas_quda_bytes += (3*x.real_length*x.precision) / (x.Nc * x.Ns);
  }
...
void xpyCuda(ParitySpinor x, ParitySpinor y) {
  ...
  if (x.precision == QUDA_DOUBLE_PRECISION) {
    ...
    xpyKernel<<<blasGrid, blasBlock>>>((float2*)x.spinor, (float2*)y.spinor, x.length/2);
  } else {
    int spinor_bytes = x.length*sizeof(short);
    cudaBindTexture(0, texHalf1, x.spinor, spinor_bytes); 
    cudaBindTexture(0, texNorm1, x.spinorNorm, spinor_bytes/12);    
...
void axpyCuda(double a, ParitySpinor x, ParitySpinor y) {
  ...
  if (x.precision == QUDA_DOUBLE_PRECISION) {
    ...
    axpyKernel<<<blasGrid, blasBlock>>>((float)a, (float2*)x.spinor, (float2*)y.spinor, x.length/2);
  } else {
    int spinor_bytes = x.length*sizeof(short);
    cudaBindTexture(0, texHalf1, x.spinor, spinor_bytes); 
    cudaBindTexture(0, texNorm1, x.spinorNorm, spinor_bytes/12);    
...
void xpayCuda(ParitySpinor x, double a, ParitySpinor y) {
  ...
  if (x.precision == QUDA_DOUBLE_PRECISION) {
    ...
    xpayKernel<<<blasGrid, blasBlock>>>((float2*)x.spinor, (float)a, (float2*)y.spinor, x.length/2);
  } else {
    int spinor_bytes = x.length*sizeof(short);
    cudaBindTexture(0, texHalf1, x.spinor, spinor_bytes); 
    cudaBindTexture(0, texNorm1, x.spinorNorm, spinor_bytes/12);    
...
void mxpyCuda(ParitySpinor x, ParitySpinor y) {
  ...
  if (x.precision == QUDA_DOUBLE_PRECISION) {
    ...
    mxpyKernel<<<blasGrid, blasBlock>>>((float2*)x.spinor, (float2*)y.spinor, x.length/2);
  } else {
    int spinor_bytes = x.length*sizeof(short);
    cudaBindTexture(0, texHalf1, x.spinor, spinor_bytes); 
    cudaBindTexture(0, texNorm1, x.spinorNorm, spinor_bytes/12);    
...
void axCuda(double a, ParitySpinor x) {
  ...
  if (x.precision == QUDA_DOUBLE_PRECISION) {
    ...
    blas_quda_bytes += (2*x.real_length*x.precision) / (x.Nc * x.Ns);
  }
...
void cxpaypbzCuda(ParitySpinor x, double2 a, ParitySpinor y, double2 b, ParitySpinor z) {
  ...
  if (x.precision == QUDA_DOUBLE_PRECISION) {
    ...
    blas_quda_bytes += (4*x.real_length*x.precision) / (x.Nc * x.Ns);
  }
}
...
void axpyZpbxCuda(double a, ParitySpinor x, ParitySpinor y, ParitySpinor z, double b) {
  ...
  if (x.precision == QUDA_DOUBLE_PRECISION) {
    ...
    blas_quda_bytes += (5*x.real_length*x.precision) / (x.Nc * x.Ns);
  }
...
void caxpbypzYmbwCuda(double2 a, ParitySpinor x, double2 b, ParitySpinor y,
  ...
  if (x.precision == QUDA_DOUBLE_PRECISION) {
    ...
    blas_quda_bytes += (6*x.real_length*x.precision) / (x.Nc * x.Ns);
  }
...
double sumCuda(ParitySpinor a) {
  ...
  if (a.precision == QUDA_DOUBLE_PRECISION) {
    ...
    blas_quda_bytes += (a.real_length*a.precision) / (a.Nc * a.Ns);
...
double reDotProductCuda(ParitySpinor a, ParitySpinor b) {
  ...
  if (a.precision == QUDA_DOUBLE_PRECISION) {
    ...
    blas_quda_bytes += (2*a.real_length*a.precision) / (a.Nc * a.Ns);
    return reDotProductHCuda((float*)a.spinorNorm, (float*)b.spinorNorm, a.stride, a.volume, 14, a.precision);
  }
}
...
double3 caxpbypzYmbwcDotProductWYNormYQuda(double2 a, ParitySpinor x, double2 b, ParitySpinor y,
  ...
  if (x.precision == QUDA_DOUBLE_PRECISION) {
    ...
    float2 af2 = make_float2((float)a.x, (float)a.y);
    float2 bf2 = make_float2((float)b.x, (float)b.y);
    blas_quda_bytes += (7*x.real_length*x.precision) / (x.Nc * x.Ns);
