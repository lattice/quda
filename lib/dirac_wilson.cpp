...
#ifdef NEW_DSLASH
    ApplyWilson(out, in, *gauge, 0.0, in, parity, dagger, commDim, DSLASH4_WILSON);
#else
...
#ifdef NEW_DSLASH
    ApplyWilson(out, in, *gauge, k, x, parity, dagger, commDim, DSLASH4_WILSON);
#else
...
#ifdef NEW_DSLASH
    ApplyWilson(out, in, *gauge, -kappa, in, QUDA_INVALID_PARITY, dagger, commDim, DSLASH4_WILSON);
#else
