...
//special types needed for compatibility with QUDA blas:
   ...
   template <> void ComputeRitz<libtype::magma_lib>(EigCGArgs &args)
   {
     ...
     qudaHostRegister(static_cast<void *>(evecm), m*m*sizeof(Complex),  qudaHostRegisterDefault);
     ...
     qudaHostRegister(static_cast<void *>(evecm1), m*m*sizeof(Complex),  qudaHostRegisterDefault);
