...
#define READ_CLOVER_DOUBLE_TEX(clover, chi)			       \
  double2 C0 = fetch_double2_texobj((clover), sid + (18*chi+0)*cl_stride);    \
  double2 C1 = fetch_double2_texobj((clover), sid + (18*chi+1)*cl_stride);    \
  double2 C2 = fetch_double2_texobj((clover), sid + (18*chi+2)*cl_stride);    \
  double2 C3 = fetch_double2_texobj((clover), sid + (18*chi+3)*cl_stride);    \
  double2 C4 = fetch_double2_texobj((clover), sid + (18*chi+4)*cl_stride);    \
  double2 C5 = fetch_double2_texobj((clover), sid + (18*chi+5)*cl_stride);    \
  double2 C6 = fetch_double2_texobj((clover), sid + (18*chi+6)*cl_stride);    \
  double2 C7 = fetch_double2_texobj((clover), sid + (18*chi+7)*cl_stride);    \
  double2 C8 = fetch_double2_texobj((clover), sid + (18*chi+8)*cl_stride);    \
  double2 C9 = fetch_double2_texobj((clover), sid + (18*chi+9)*cl_stride);    \
  double2 C10 = fetch_double2_texobj((clover), sid + (18*chi+10)*cl_stride);  \
  double2 C11 = fetch_double2_texobj((clover), sid + (18*chi+11)*cl_stride);  \
  double2 C12 = fetch_double2_texobj((clover), sid + (18*chi+12)*cl_stride);  \
  double2 C13 = fetch_double2_texobj((clover), sid + (18*chi+13)*cl_stride);  \
  double2 C14 = fetch_double2_texobj((clover), sid + (18*chi+14)*cl_stride);  \
  double2 C15 = fetch_double2_texobj((clover), sid + (18*chi+15)*cl_stride);  \
  double2 C16 = fetch_double2_texobj((clover), sid + (18*chi+16)*cl_stride);  \
  double2 C17 = fetch_double2_texobj((clover), sid + (18*chi+17)*cl_stride);

  #else*/

#define READ_CLOVER_DOUBLE_TEX(clover, chi)			       \
  double2 C0 = fetch_double2_new((clover), sid + (18*chi+0)*cl_stride);    \
  double2 C1 = fetch_double2_new((clover), sid + (18*chi+1)*cl_stride);    \
  double2 C2 = fetch_double2_new((clover), sid + (18*chi+2)*cl_stride);    \
  double2 C3 = fetch_double2_new((clover), sid + (18*chi+3)*cl_stride);    \
  double2 C4 = fetch_double2_new((clover), sid + (18*chi+4)*cl_stride);    \
  double2 C5 = fetch_double2_new((clover), sid + (18*chi+5)*cl_stride);    \
  double2 C6 = fetch_double2_new((clover), sid + (18*chi+6)*cl_stride);    \
  double2 C7 = fetch_double2_new((clover), sid + (18*chi+7)*cl_stride);    \
  double2 C8 = fetch_double2_new((clover), sid + (18*chi+8)*cl_stride);    \
  double2 C9 = fetch_double2_new((clover), sid + (18*chi+9)*cl_stride);    \
  double2 C10 = fetch_double2_new((clover), sid + (18*chi+10)*cl_stride);  \
  double2 C11 = fetch_double2_new((clover), sid + (18*chi+11)*cl_stride);  \
  double2 C12 = fetch_double2_new((clover), sid + (18*chi+12)*cl_stride);  \
  double2 C13 = fetch_double2_new((clover), sid + (18*chi+13)*cl_stride);  \
  double2 C14 = fetch_double2_new((clover), sid + (18*chi+14)*cl_stride);  \
  double2 C15 = fetch_double2_new((clover), sid + (18*chi+15)*cl_stride);  \
  double2 C16 = fetch_double2_new((clover), sid + (18*chi+16)*cl_stride);  \
  double2 C17 = fetch_double2_new((clover), sid + (18*chi+17)*cl_stride);
