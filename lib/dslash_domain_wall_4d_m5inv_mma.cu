#include <kernels/dslash_domain_wall_4d_m5inv_mma.cuh>
#include <dslash_domain_wall_4d_fused_m5_mma.hpp>
...
namespace quda
{
  ...
  void ApplyDomainWall4DM5invMma(ColorSpinorField &out, const ColorSpinorField &in, const GaugeField &U, double a,
                              ...
                              TimeProfile &profile)
  {
    auto dummy_list = Dslash5KernelList<domainWall4DM5invMma>();
    instantiate<DomainWall4DApplyFusedM5Mma>(out, in, U, a, m_5, b_5, c_5, x, y, parity, dagger, comm_override, m_f,
                                          dummy_list, profile);
  }
#else
