...
#    if dir%2 == 0:
#      str += "param.dc.Ls*param.dc.ghostFaceCB[" + `dir/2` + "] + "
    ...
    if dir % 2 == 0:
        ...
        if domain_wall: str += "const int ga_idx = param.dc.volume_4d_cb+(face_idx % param.dc.ghostFaceCB[" + `dir/2` + "]);\n"
    ...
    load_half = ""
    if domain_wall : 
        load_half += "const int sp_stride_pad = param.dc.Ls*param.dc.ghostFaceCB[" + `dir/2` + "];\n"
    else :
