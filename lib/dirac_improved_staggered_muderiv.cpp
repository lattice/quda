...
namespace quda {
  ...
  DiracImprovedStaggeredMuDeriv::DiracImprovedStaggeredMuDeriv(const DiracParam &param)
    : DiracImprovedStaggered(param) { }
  DiracImprovedStaggeredMuDeriv::DiracImprovedStaggeredMuDeriv(const DiracImprovedStaggeredMuDeriv &dirac)
    : DiracImprovedStaggered(dirac) { }

  DiracImprovedStaggeredMuDeriv::~DiracImprovedStaggeredMuDeriv() { }
 ...
 //  }
  ...
  void DiracImprovedStaggeredMuDeriv::M(ColorSpinorField &out, const ColorSpinorField &in, int order) const
  {
