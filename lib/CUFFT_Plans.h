...
#ifndef HIPFFT_PLANS_H
#define HIPFFT_PLANS_H
...
/**
 * @brief Call HIPFFT to perform a single-precision complex-to-complex transform plan in the transform direction 
 ...
 */
inline void ApplyFFT(hipfftHandle &plan, float2 *data_in, float2 *data_out, int direction){
 ...
 * @param[in] direction, the transform direction: HIPFFT_FORWARD or HIPFFT_BACKWARD
 */
inline void ApplyFFT(hipfftHandle &plan, double2 *data_in, double2 *data_out, int direction){
 ...
 */
void SetPlanFFTMany( hipfftHandle &plan, int4 size, int dim, float2 *data){
  switch ( dim ) {
  case 1:
  { int n[1] = { size.w };
 ...
 * @param[in] data, pointer to the double-precision complex data, this is only passed to choose between single and double precision
 */
inline void SetPlanFFTMany( hipfftHandle &plan, int4 size, int dim, double2 *data){
  switch ( dim ) {
  case 1:
  { int n[1] = { size.w };
 ...
 * @param[in] data, pointer to the double-precision complex data, this is only passed to choose between single and double precision
 */
inline void SetPlanFFT2DMany( hipfftHandle &plan, int4 size, int dim, float2 *data){
  switch ( dim ) {
  case 0:
 ...
 * @param[in] data, pointer to the double-precision complex data, this is only passed to choose between single and double precision
 */
inline void SetPlanFFT2DMany( hipfftHandle &plan, int4 size, int dim, double2 *data){
  switch ( dim ) {
  case 0:
  { int n[2] = { size.w, size.z };
