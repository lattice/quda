...
namespace quda
{
  ...
  void DiracImprovedStaggeredKD::MLocal(ColorSpinorField &out, const ColorSpinorField &in) const {
    ...
    // flops += ...
    errorQuda("DiracImprovedStaggeredKD::MLocal has not been implemented yet");
  }
