...
namespace quda
{
  ...
  //minimum<float>);
  template void transform_reduce<double, complex<float>, unsigned int, abs_min_<float, float>, minimum<double>>(
    QudaFieldLocation, std::vector<double> &, std::vector<complex<float> *> const &, unsigned int, abs_min_<float, float>, double,
    minimum<double>);
  ...
  //maximum<float>);
  template void transform_reduce<double, complex<int>, unsigned int, abs_max_<float, int>, maximum<double>>(
    QudaFieldLocation, std::vector<double> &, std::vector<complex<int> *> const &, unsigned int, abs_max_<float, int>, double,
    maximum<double>);
  ...
  //maximum<float>);
  template void transform_reduce<double, complex<float>, unsigned int, abs_max_<float, float>, maximum<double>>(
    QudaFieldLocation, std::vector<double> &, std::vector<complex<float> *> const &, unsigned int, abs_max_<float, float>, double,
    maximum<double>);
  ...
  //minimum<float>);
  template void transform_reduce<double, complex<int>, unsigned int, abs_min_<float, int>, minimum<double>>(
  QudaFieldLocation, std::vector<double> &, std::vector<complex<int> *> const &, unsigned int, abs_min_<float, int>, double,
  minimum<double>);
  ...
  //minimum<float>);
  template void transform_reduce<double, complex<short>, unsigned int, abs_min_<float, short>, minimum<double>>(
    QudaFieldLocation, std::vector<double> &, std::vector<complex<short> *> const &, unsigned int, abs_min_<float, short>, double,
    minimum<double>);
  ...
  template void transform_reduce<double, complex<signed char>, unsigned int, abs_max_<float, signed char>, maximum<double>>(
    QudaFieldLocation, std::vector<double> &, std::vector<complex<signed char> *> const &, unsigned int,
    abs_max_<float, signed char>, double, maximum<double>);
  ...
  template void transform_reduce<double, complex<signed char>, unsigned int, abs_min_<float, signed char>, minimum<double>>(
    QudaFieldLocation, std::vector<double> &, std::vector<complex<signed char> *> const &, unsigned int,
    abs_min_<float, signed char>, double, minimum<double>);
  ...
  //maximum<float>);
  template void transform_reduce<double, complex<short>, unsigned int, abs_max_<float, short>, maximum<double>>(
    QudaFieldLocation, std::vector<double> &, std::vector<complex<short> *> const &, unsigned int, abs_max_<float, short>, double,
    maximum<double>);
  ...
  template double transform_reduce<double, complex<float>, unsigned long, abs_max_<float, float>, maximum<double>>(
    QudaFieldLocation, complex<float> const *, unsigned long, abs_max_<float, float>, double, maximum<double>);
  ...
  template double transform_reduce<double, complex<short>, unsigned long, abs_max_<float, short>, maximum<double>>(
    QudaFieldLocation, complex<short> const *, unsigned long, abs_max_<float, short>, double, maximum<double>);
  ...
  template double transform_reduce<double, complex<float>, unsigned long, abs_min_<float, float>, minimum<double>>(
    QudaFieldLocation, complex<float> const *, unsigned long, abs_min_<float, float>, double, minimum<double>);
