...
#include <reduce_mixed_core.h>
  ...
  */
  __device__ double norm2_(const double2 &a) { return (double)a.x*(double)a.x + (double)a.y*(double)a.y; }
  ...
  */
    __device__ double dot_(const double2 &a, const double2 &b) { return (double)a.x*(double)b.x + (double)a.y*(double)b.y; }
